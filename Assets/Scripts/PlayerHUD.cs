...
public class PlayerHUD : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        catch (System.Exception e)
        {
            ...
            sb.AppendLine("wasAlive " + wasAlive);
            sb.AppendLine("warningText " + warningText);
            sb.AppendLine("missileDirectionImage " + missileDirectionImage);
            sb.AppendLine("geesOverlay " + geesOverlay);
            sb.AppendLine("whiteFade " + whiteFade);
            sb.AppendLine("trackerText " + trackerText);
            sb.AppendLine("trackerImg " + trackerImg);
            sb.AppendLine("trackerText " + trackerText);
            sb.AppendLine("aimTargetingChild " + aimTargetingChild);
            sb.AppendLine("aimRect " + aimRect);
            sb.AppendLine("rawImageRect " + rawImageRect);
            sb.AppendLine("aimGroup " + aimGroup);
            sb.AppendLine("targetColorables " + targetColorables);
